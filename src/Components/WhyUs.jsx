...
export default function WhyUs() {
  return (
    ...
    <div class="mt-6 mb-6GF text-4xl sm:text-5xl  font-extrabold leading-7 text-black-500 font-regular mb-6 text-center ">
        Why Us?
    </div>
    <div class="container px-5 py-12 mx-auto bg-brown ">
